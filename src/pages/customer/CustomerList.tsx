...
const CustomerList: React.FC = () => {
  ...
  // Mock Data
  const customers = [
    { id: 'CUST-10021', name: 'Rahul Sharma', pan: 'ABCDE1234F', phone: '9876543210', score: 785, bank: 'HDFC Bank', income: '₹1.2L', status: 'Approved' },
    { id: 'CUST-10022', name: 'Priya Singh', pan: 'FGHIJ5678K', phone: '9876543211', score: 642, bank: 'ICICI Bank', income: '₹85K', status: 'Pending' },
    { id: 'CUST-10023', name: 'Amit Verma', pan: 'LMNO P9012Q', phone: '9876543212', score: 812, bank: 'SBI', income: '₹2.5L', status: 'Approved' },
    { id: 'CUST-10024', name: 'Sneha Kapur', pan: 'RSTUV3456W', phone: '9876543213', score: 580, bank: 'Axis Bank', income: '₹45K', status: 'Rejected' },
    { id: 'CUST-10025', name: 'Vikram Joshi', pan: 'XYZAB7890C', phone: '9876543214', score: 720, bank: 'Kotak Bank', income: '₹1.1L', status: 'Approved' },
    { id: 'CUST-10026', name: 'Anjali Desai', pan: 'DEFGH1234I', phone: '9876543215', score: 690, bank: 'HDFC Bank', income: '₹95K', status: 'Pending' },
    { id: 'CUST-10027', name: 'Suresh Iyer', pan: 'JKLMN5678O', phone: '9876543216', score: 755, bank: 'ICICI Bank', income: '₹1.8L', status: 'Approved' },
  ];
  ...
  const columns = [
    {
      header: 'Customer ID',
      accessorKey: 'id',
      cell: (info: any) => <span className="font-semibold text-primary-600">{info.getValue()}</span>
    },
    {
      header: 'Name',
      accessorKey: 'name',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 uppercase tracking-tight">Customer Repository</h1>
          <p className="text-slate-500">Search and filter through all customers in the CIBIL Bureau database.</p>
        </div>
      ...
      <Card className="overflow-visible">
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              Filters
              {showFilters ? <X size={14} className="ml-2" /> : <ChevronDown size={14} className="ml-2" />}
            </Button>
          </div>
        </div>
        ...
        {showFilters && (
          <div className="mt-4 pt-4 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-500 uppercase">Bank Type</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-500 uppercase">Credit Score Range</label>
              <select className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-500 uppercase">Upload Date Range</label>
              <div className="flex items-center bg-slate-50 border border-slate-200 rounded-lg px-3 py-2">
                <Calendar size={14} className="text-slate-400 mr-2" />
                <span className="text-sm text-slate-600">Select Date Range</span>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 flex items-center">
          ...
          <div>
            <p className="text-xs font-medium text-slate-500">Recent Applications</p>
